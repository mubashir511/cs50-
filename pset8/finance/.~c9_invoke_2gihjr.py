...
def changePassword():
    ...
    if request.method == "POST":
        ...
        # find hash value of old password given by user
        old_password_hash = generate_password_hash((request.form.get("old_password")), method='pbkdf2:sha256', salt_length=8)
